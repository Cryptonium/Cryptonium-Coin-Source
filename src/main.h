...
static const int64 MAX_MONEY = 66000000 * COIN; // Cryptonium: maximum of 66M coins (given some randomness)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 600 / 250; // Cryptonium: 600 blocks found a day. Priority cutoff is 1 cryptonium day / 250 bytes.
    }
