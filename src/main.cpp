...
uint256 hashGenesisBlock("0xa3f35aaf2c2c376db24f83537c3bc51dfd0b09fbe511731cea8bf7fca64d28df");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Cryptonium: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Cryptonium Signed Message:\n";
...
static const int64 nTargetTimespan = 3 * 60 * 60; // Cryptonium: every 3 hours
static const int64 nTargetSpacing = 180; // Cryptonium: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Cryptonium: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cryptonium miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cryptonium", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa3f35aaf2c2c376db24f83537c3bc51dfd0b09fbe511731cea8bf7fca64d28df");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1.4.2014 Cryptonium was created.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x7a0b88eb8c30b2b6963cde4bbb9e46918cb941fcd7993765507954979fbfebde"));
...
unsigned char pchMessageStart[4] = { 0xc2, 0xc5, 0xc6, 0xc1 }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Cryptoniumd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
