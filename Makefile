#############################################################################
# Makefile for building: Cryptonium
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sat Jan 4 16:15:04 2014
# Project:  Cryptonium.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_UPNP=1 -o Makefile Cryptonium.pro
#############################################################################
...
Makefile: Cryptonium.pro  ../Qt/4.8.5/mkspecs/win32-g++/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=1 -o Makefile Cryptonium.pro
